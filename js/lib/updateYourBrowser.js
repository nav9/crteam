...
//options DerGer4etZ4elt!
    ...
    this.op.vsakt = {i: 11, f: 37, o: 28, s: 8, n: 20, c: 41};
    ...
    var t = '<p>Oops!!! Your browser (%s) is <b>out of date</b>.</p>\
	<p>Many of this website\'s modern features won\'t function on old browsers. Using an old browser is also a security risk!</p>\
        <a%s>Please update your browser</a> (Firefox recommended) right away, clear the browser cache and return back to CRTeam\'s website. On Google Chrome if the gallery blacks/whites out, it is due to a known bug in Chrome which requires a graphics accelerator. Have a nice day! :-)';
...
background: rgb(249,218,4);\
text-align:left; cursor:pointer; \
font-family: Arial,Helvetica,sans-serif; color:#000; font-size: 12px;}\
.buorg div { padding: 20px 40px 20px 50px; background: rgb(249,218,4);} \
.buorg a,.buorg a:visited  {color:#E25600; text-decoration: underline;}\
#buorgclose { position: absolute; right: 6px; top:-2px; height: 20px; width: 12px; font-weight: bold;font-size:18px; padding: 15px 0px 0px 0px; }";
